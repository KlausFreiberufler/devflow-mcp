 ...
 */
import { DEFAULT_STRICTNESS, STRICTNESS_LABELS, } from '../config/types.js';
...
function generateStrictnessRules(s) {
    ...
    for (const section of sections) {
        ...
        if (!ruleText)
            continue; // Skip empty rules (e.g., flowRequired level 1)
 ...
 */
export function generateClaudeMdContent(projectName, techStack, strictness) {
 ...
 */
export function generateGuidelinesBlock(guidelines) {
