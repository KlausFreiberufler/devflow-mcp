 ...
 *
 * Generates project-specific CLAUDE.md content with WorkFlow Pro rules.
 * The template includes all workflow states, mandatory processes, and guardrails.
 */

export const MARKER_START = '<!-- WORKFLOW-PRO-RULES-START -->';
export const MARKER_END = '<!-- WORKFLOW-PRO-RULES-END -->';
