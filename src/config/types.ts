...
export const DEFAULT_CONFIG: RemoteConfig = {
  ...
  requiredFields: {
    ...
    code_review: {
      ...
      message: 'agentSummary und testingInstructions sind Pflicht beim Uebergang zu code_review. Beschreibe was implementiert wurde und was der User testen soll.',
    },
  },
  blockedTransitions: {
    plan_review: [
