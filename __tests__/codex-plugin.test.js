 ...
 * - skills/ wurde build-time gefüllt (24 dirs)
...
test('skills/ folder populated by build (24 dirs)', () => {
  ...
  assert.equal(dirs.length, 24, `expected 24 skill folders, found ${dirs.length}`)
  // canonical reference
